import type { AnesthesiaGuideline } from "./schema"

export const builtInGuidelines: AnesthesiaGuideline[] = [
  {
    ...
    summary: "The American Society of Anesthesiologists practice guidelines for management of the difficult airway. Focuses on pre-planned strategies for anticipated and unanticipated difficult airways, highlighting the distinction between awake intubation and intubation after induction of anesthesia.",
    full_content: `### Key Clinical Recommendations:
...
4. **Unanticipated Difficult Airway (Post-Induction)**:
  ...
  },
  {
    ...
    summary: "Advanced Cardiovascular Life Support guidelines for adult cardiac arrest. Covers cardiopulmonary resuscitation (CPR) and pharmaceutical interventions for shockable (VF/pVT) and non-shockable (Asystole/PEA) rhythms.",
    full_content: `### Core Guidelines:
...
- **T's**: Tension pneumothorax, Tamponade (cardiac), Toxins, Thrombosis (pulmonary), Thrombosis (coronary).`,
  ...
  },
  {
    ...
    organization: "MHAUS",
    category: "Emergency Protocols",
    summary: "Step-by-step emergency response guidelines for managing a Malignant Hyperthermia (MH) crisis in the operating room. Triggered by volatile anesthetics (halothane, isoflurane, sevoflurane, desflurane) and depolarizing muscle relaxants (succinylcholine).",
    full_content: `### Diagnostic Indicators:
...
6. **Treat Cardiac Arrhythmias**:
  ...
  },
  {
    ...
    organization: "ASRA",
    category: "Emergency Protocols",
    summary: "The American Society of Regional Anesthesia and Pain Medicine guidelines for managing Local Anesthetic Systemic Toxicity. Highlights airway management, seizure control, and Lipid Emulsion Therapy (Intralipid).",
    full_content: `### Clinical Presentation:
