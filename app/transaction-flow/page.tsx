        ...
        <div className="flex flex-col gap-4 text-center sm:text-left">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-6">
            ...
            <div className="text-xs sm:text-right text-muted-foreground font-mono bg-muted/40 p-3 rounded-lg border">
              ...
              <div>Generated: June 15, 2026</div>
              <div>Gateway Partner: Midtrans Snap</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 mt-6">
          ...
          <div className="border rounded-xl p-5 bg-card print-card flex flex-col gap-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-base">Initiate Secure Checkout Token</h3>
            </div>
            <p className="text-xs text-muted-foreground leading-relaxed">
              The user enters their billing name and profile details and clicks **"Upgrade & Pay"**. The frontend posts a request to the backend API endpoint (<code>/api/support/checkout</code>). The server creates a pending record in the Supabase database and requests a secure Snap token from the Midtrans transaction endpoints.
            </p>
            <div className="rounded-lg border bg-muted/20 p-4 font-mono text-[9px] text-muted-foreground space-y-1">
              <div className="border-b pb-1 font-bold text-foreground">Backend Request to Midtrans API</div>
              <div>POST https://app.sandbox.midtrans.com/snap/v1/transactions</div>
              <div>Body: &#123; "transaction_details": &#123; "order_id": "SUPPORT-8C2A", "gross_amount": 150000 &#125;, "customer_details": &#123; "first_name": "Dr. Jane Mercer" &#125; &#125;</div>
            </div>
          </div>
          ...
          <div className="border rounded-xl p-5 bg-card print-card flex flex-col gap-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-base">Midtrans Snap Payment Processing</h3>
            </div>
            <p className="text-xs text-muted-foreground leading-relaxed">
              The Midtrans Snap.js overlay drawer opens on the application. The user is displayed the merchant details, order ID, and the exact price in IDR. They complete the transaction using QRIS, Credit Card, ShopeePay, GoPay, or Virtual Accounts.
            </p>
            <div className="rounded-lg border border-amber-500/20 bg-amber-500/[0.02] p-4 font-mono text-[10px] space-y-1.5 max-w-sm mx-auto w-full">
              <div className="flex items-center justify-between border-b pb-1">
                <span className="font-bold text-amber-700">Midtrans Secure Snap Payment</span>
